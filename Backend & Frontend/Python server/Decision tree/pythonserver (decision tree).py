...
def lookupsICAO():
    ...
    # dest, predicted_alternates = random_forest_model.make_prediction(destination, aircraft)
    dest, predicted_alternates = decision_tree_model.make_prediction(destination, aircraft)
...
def getairportinfo():
    ...
    airport_data = decision_tree_model.get_airport_data(airport)
